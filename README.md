...
**IT Student | AWS Enthusiast | Flutter Developer | Fullstack Developer**

I'm a college student building practical, real-world apps — from mobile apps in Flutter to full-stack web platforms — and sharpening my skills through internship tasks and hackathons.


- 🔭 Currently building **full-stack web apps and Flutter mobile apps**
- 🌱 Learning **advanced Flutter state management and backend integration**
- 💬 Ask me about **Flutter, Node.js/Express, MongoDB**

---

### Tech Stack
[![](https://skillicons.dev/icons?i=flutter,dart,js,html,css,nodejs,express,mongodb,git,vscode&perline=10)](https://skillicons.dev)
...
|---|---|---|
| **[portfolio-websites](https://github.com/Thangamani-IT-07/portfolio-websites)** | Full-stack personal portfolio site with Node.js/Express backend and MongoDB | `Node.js` `Express` `MongoDB` |
